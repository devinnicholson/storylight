...
- [`benchmarks/bookforge-session-sse-consolidation-2026-08-24.json`](benchmarks/bookforge-session-sse-consolidation-2026-08-24.json): authoritative session-stream consolidation; 50% fewer persistent streams, no post-acceptance session GET or healthy-stream polling, 63.1 ms terminal activation, continuous video playback, and 21.3 ms fresh-projector recovery
