...
- [`benchmarks/bookforge-edge-planner-residency-2026-08-30.json`](benchmarks/bookforge-edge-planner-residency-2026-08-30.json): deployed Jetson lifecycle warmup acceptance; isolated 5.218 seconds of cold-residency overhead in the first Vertex scene, verified automatic 877 MB GPU residency after restart, measured a 3.183-second uncached plan and 0.426 ms exact cache hit, and rejected a 2048-token context after a 3.3% latency regression
...
- [`experiments/jax-fidelity-lab/remat-ab-2026-09-03.json`](experiments/jax-fidelity-lab/remat-ab-2026-09-03.json): repeated two-L4 JAX rematerialization gate; no-remat improved steady steps by 11.1–38.9% but lost on the 100-step end-to-end path, producing a conservative 2,941-step promotion boundary
...
- [`benchmarks/bookforge-gemma4-g4-export-and-jetson-build-2026-08-30.json`](benchmarks/bookforge-gemma4-g4-export-and-jetson-build-2026-08-30.json): completed checksum-bound Gemma 4 E2B INT4-AWQ export on a finite GCP G4 job, successful 1,280-token Jetson TensorRT engine build, and exact NVMe-backed PLE streaming that makes no-swap inference fit in 8 GB
- [`benchmarks/jetson-gemma4-tensorrt-repair-2026-09-01.json`](benchmarks/jetson-gemma4-tensorrt-repair-2026-09-01.json): final 20/20 schema, privacy, and 80-requirement semantic TensorRT acceptance plus five forbidden-term checks and human relationship review; 27.12 generated tokens/second, about 1.58 seconds of steady-state GPU planning work, and a 3.84 GB unified-memory peak with Gemma 3 restored afterward
- [`benchmarks/jetson-gemma4-tensorrt-integrated-planner-2026-09-01.json`](benchmarks/jetson-gemma4-tensorrt-integrated-planner-2026-09-01.json): the same accepted engine through Bookforge's production structured planner and natural privacy rewrite; 20/20 automatic semantic/privacy pass at 1.599 seconds mean, 1.605 seconds median, and 1.927 seconds maximum, with a 64-token hard ceiling
- [`benchmarks/jetson-tensorrt-appliance-handoff-2026-09-01.json`](benchmarks/jetson-tensorrt-appliance-handoff-2026-09-01.json): measured global-OOM root cause and reboot-safe runtime handoff; draining a loaded 1.7 GB Ollama worker and stale 1.7 GB kiosk raised available memory to 4.93 GB, then a refreshed projector plus resident TensorRT held 1.00 GB headroom and completed the relationship smoke in 1.466 seconds without swap
