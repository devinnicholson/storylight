...
- [`benchmarks/bookforge-inference-critical-path-2026-08-26.json`](benchmarks/bookforge-inference-critical-path-2026-08-26.json): faithful Jetson planning and Modal GPU-snapshot acceptance; a 1.634-second compact candidate was rejected after failing all five semantic gates, while the selected named schema averaged 2.773 seconds and the best cold renderer restore fell from 20.608 to 6.424 seconds
