...
- [`benchmarks/bookforge-session-sse-consolidation-2026-08-24.json`](benchmarks/bookforge-session-sse-consolidation-2026-08-24.json): authoritative session-stream consolidation; 50% fewer persistent streams, no post-acceptance GET or healthy-stream polling, visual upgrades reuse the reader with 0 ms sync while preserving its cursor, and terminal playback/recovery remain live
