...
- [`benchmarks/bookforge-inference-critical-path-2026-08-26.json`](benchmarks/bookforge-inference-critical-path-2026-08-26.json): compact Jetson planning and Modal GPU-snapshot acceptance; uncached Gemma planning fell to 2.124 seconds and the best cold renderer restore fell from 20.608 to 9.028 seconds without changing the quality contract
