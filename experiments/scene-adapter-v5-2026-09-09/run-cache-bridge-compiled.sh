...
b308c7e236ef81b30915fe416639a6b8032e7a5faa2b94a422754082d62a4939  /tmp/storylight-v5-cache-bridge-compiled.py
...
exec /usr/bin/timeout --signal=TERM --kill-after=30s 960s \
  .venv/bin/python /tmp/storylight-v5-cache-bridge-compiled.py \
  --compiler-cache-root /tmp/storylight-v5-bridge-compiler-cache-01 \
