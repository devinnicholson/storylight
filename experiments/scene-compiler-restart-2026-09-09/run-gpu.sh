...
4a3c44494e45821817b56fe5bb846d520e30a0bd0e28797160316710aaa37e00  /tmp/bookforge-compiler-restart-run.py
...
exec /usr/bin/timeout --signal=TERM --kill-after=30s 960s \
  .venv/bin/python /tmp/bookforge-compiler-restart-run.py \
  --arm "$arm" "${prior_args[@]}" \
  --compiled-profile support/cache-bridge-compiled.py \
  --compiler-cache-root /tmp/bookforge-v5-seeded-compiler-cache-01 \
