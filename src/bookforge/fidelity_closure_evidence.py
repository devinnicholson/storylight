...
_COST_SOURCE_PRODUCERS = {
    "gcp": "bookforge-gcp-cost-source",
    "modal": "bookforge-modal-cost-source",
}
...
def validate_terminal_evidence(
    ...
    *,
    ...
    if (
        ...
        or health.get("producer") != "bookforge-terminal-health-recorder"
    ...
    if promoted:
        ...
        if (
            ...
            or rollback.get("producer") != "bookforge-trained-planner-rollback-state"
...
def validate_reconciliation_evidence(
    ...
    *,
    ...
    if (
        ...
        or cost.get("producer") != "bookforge-fidelity-cost-reconciler"
    ...
    if (
        ...
        or inventory.get("producer") != "bookforge-fidelity-resource-reconciler"
