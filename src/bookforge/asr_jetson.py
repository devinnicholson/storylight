...
from bookforge.asr_backend import AsrBackendError, AsrBackendUnavailableError
...
class WhisperTrtBackend:
    ...
    async def transcribe(self, audio: bytes, content_type: str) -> TranscriptionResponse:
        ...
        async with self._lock:
            with tempfile.TemporaryDirectory(prefix="bookforge-whisper-trt-") as directory:
