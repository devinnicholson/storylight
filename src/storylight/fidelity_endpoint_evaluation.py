...
from storylight.fidelity_evaluation import SurfaceEvaluation, concept_vocabulary, evaluate_surface
...
HIDDEN_EVALUATION_STATE_ROOT = Path("/var/lib/storylight/fidelity-hidden-evaluation")
...
def main() -> None:
    ...
    if split is DatasetSplit.HIDDEN:
        ...
        if os.environ.get("STORYLIGHT_HIDDEN_EVAL_APPROVAL") != token:
