...
from storylight.domain import AssetKind, AssetState, StoryPack
    ...
    *,
    ...
    try:
        ...
        (temporary / "README.md").write_text(
            ...
            "network access:\n\n"
            "```bash\n"
            f"python -m storylight.pack_installer {pack_name} --asset-root .\n"
            "```\n\n"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build a portable, checksum-verifiable Storylight handoff directory"
    )
