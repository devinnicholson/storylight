...
from storylight import privacy_policy
...
from storylight.live_scene_grounding import LiveSceneGroundingError, prepare_grounded_wire
from storylight.model_client import StructuredModelClient
from storylight.scene_facts import SceneFactsPrivacyError, SceneFactsV2, _validate_style_privacy
    ...
    def to_page(
        ...
        *,
        ...
        if render_contract == "concise":
            ...
            from storylight.tensorrt_slot_client import _semantic_privacy_separator
...
LIVE_SCENE_SYSTEM_PROMPT = """You are Storylight's private edge scene planner.
    ...
    async def warmup(self) -> LiveScenePlannerWarmupResult:
        ...
        if task is None:
            task = asyncio.create_task(
                ...
                name="storylight-live-planner-warmup",
            )
        ...
        *,
        ...
        if task is None:
            task = asyncio.create_task(
                ...
                name=f"storylight-live-plan-{cache_key[:12]}",
            )
