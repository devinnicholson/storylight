...
from storylight.bounded_description import REVISION as BOUNDED_REVISION
from storylight.bounded_description import plan_bounded_description
from storylight.domain import FrozenStrictModel, ModelMetrics
...
from storylight.privacy_policy import COUNT_WORDS, privacy_tokens
from storylight.scene_facts import SceneFactsV2

REVISION = "reviewed-language-v5"
PARSER_REVISION = "dependency-scene-draft-v5"
...
class _ParserResponse(FrozenStrictModel):
    revision: Literal["dependency-scene-draft-v5"]
